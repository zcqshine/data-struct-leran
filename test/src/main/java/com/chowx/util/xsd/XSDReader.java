...
//        paseData(dataElement, "//", elementPath, "//");
    ...
    public static void main(String[] args) {
        ...
        try {
            String realPath = "/Users/zcqshine/Documents/共治物联/GT3-ZJ-金税三期标准服务清册_V2.46/附录报文/核心征管业务/申报征收/申报/HXZG_SB_00041/TaxMLBd_0610339_V1.0.xsd";

            XSDReader xsdReader = new XSDReader();

            List<ClassNode> nodes = xsdReader.paserXSD(realPath);

            File file = new File("/Users/zcqshine/Downloads/test/TaxMLBd_0610339_V1.0.txt");
